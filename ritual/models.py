...
class SimpleService(models.Model):
    ...
    description = models.TextField(blank=True, null=True, verbose_name='Описание услуги')
    price = models.IntegerField(default=0, verbose_name='Цена услуги')
    images = models.ManyToManyField('ritual.Image', related_name='simple_services', blank=True, verbose_name='Изображения')
...
class Image(models.Model):
    ...
    simple_service = models.ForeignKey(SimpleService, related_name='simple_service_images', on_delete=models.CASCADE, null=True, blank=True)
...
class Question(models.Model):
    """Модель вопроса"""
    service = models.ForeignKey(SimpleService, on_delete=models.CASCADE, related_name='questions', verbose_name='Услуга')
    user = models.ForeignKey('UserAccounts', on_delete=models.CASCADE, verbose_name='Пользователь')
...
class Rating(models.Model):
    ...
    executor = models.ForeignKey(UserAccounts, related_name='ratings', on_delete=models.CASCADE, verbose_name='Исполнитель')
