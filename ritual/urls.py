...
from .views import LoginView, RegistrationView, ReviewExecuterViewSet, RatingViewSet, ChatMessageView, \
    ...
    ClientAdminChatAPIView, UnreadMessagesAPIView, SendMessageAPIView, SimpleServiceDetail

urlpatterns = [
    path('services/', SimpleServiceList.as_view(), name='service-list'),
    path('services/<int:pk>/', SimpleServiceDetail.as_view(), name='service-detail'),
